...
int main(void)
{
  ...
  /*
  lps25hb_set_calib(74);  //kalibracja(błąd odczytu * 16)
  printf("Searching...\n");
  ...
  while (1)
  {
    ...
    //const float h = 153; // nasza wysokość n.p.m.
    ...
    printf("h = %.2f m\n", h); //obliczenie wysokości bezwzględnej

    //printf("p0 = %.2f hPa\n", p0); // odczyt ciśnienia bezwględnego
    HAL_Delay(1000);
    */
